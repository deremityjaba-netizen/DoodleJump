...
public class MenuScreen extends ScreenAdapter {
    ...
    public MenuScreen(MyGdxGame myGdxGame) {
        ...
        exitButtonView = new ButtonView(140, 456, 440, 70, myGdxGame.commonBlackFont, GameImages.BUTTON_LONG_IMG_PATH, "exit");
    ...
    private void handleInput() {
        if (Gdx.input.justTouched()) {
            ...
            if (startButtonView.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {myGdxGame.setScreen(myGdxGame.gameScreen);
            }
